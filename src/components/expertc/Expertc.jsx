    ...
    <div className="expertc">
     <div className='itimg'>
       ...
       <div className='itin'> 
          ...
          <h1 className='ith1'> Navigate Your Path with Expert Guidance: Consultancy's Finest Counseling Services.</h1>
          ...
          <div className='service'>
            <div className='servicehead'>
              <h3>Dedicated to Your Global Journey: Professional Consultancy Services for Seamless Relocation Abroad.</h3>
            </div>
