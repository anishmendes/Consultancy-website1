  ...
  return (
    <div  className="usa-page">
     <h1 className='heading1'><span className='span1'>STUDY IN</span>  AUSTRALIA</h1>
        ...
        <div class="buttons">
    <button onClick={routeTo}>About Australia</button>
...
<h2 className='h2-blue'>Requirements for Nepali Students to Study in the <span className='span-red'>Australia</span></h2>
